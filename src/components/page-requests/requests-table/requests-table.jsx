...
const RequestsTable = (props) => {
  ...
  const {requestStatus, requestId, requestIdPassanger, requestStart, requestDate, requestTime, requestCost, requestPassangersCount,
         requestIdDriver, requestCity, requestGood, requestBad, requestClientComment, requestMark} = props;
  ...
  return (
    <React.Fragment>
      <tr className="dashboard-table__row">
        ...
        <td className="dashboard-table__data"><a href="#">{requestIdPassanger}</a></td>
        ...
        <td className="dashboard-table__data"><a href="#">{requestIdDriver}</a></td>
